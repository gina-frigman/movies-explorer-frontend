            ...
            <div className="menu__container">
                <div className="menu__flexbox">
                    ...
                    <div className="menu__links">
                        <NavLink className="menu__link" to="/main" replace={true}>Главная</NavLink>
                        <NavLink className="menu__link" to="/movies" replace={true}>Фильмы</NavLink>
                        <NavLink className="menu__link" to="/saved-movies" replace={true}>Сохранённые фильмы</NavLink> 
                    </div>
               </div>
